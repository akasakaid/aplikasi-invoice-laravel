                ...
                <div class="uk-align-center">
                    ...
                    <form action="/add-invoice" method="post" class="uk-form-width-xlarge" id="add_form">
                        ...
                        <div class="uk-margin-top">
                            ...
                            <input type="date" name="tgl_invoice" id="tgl_invoice" class="uk-input" value="{{$tgl_invoice}}" readonly>
                        </div>

                        <div class="uk-margin-top">
                            <label for="customer" class="uk-label">Customer</label>
                            <select name="customer" id="customer" class="uk-select" disabled>
                        ...
                        <div class="uk-margin-top">
                            ...
                            <select name="status" id="status" class="uk-select" disabled>
                                @if ($status == 'paid')
                        ...
                        <div class="uk-margin-top">
                            ...
                            <input type="text" name="catatan" id="catatan" class="uk-input" value="{{$catatan}}" readonly>
                        </div>
                        
                        <div class="uk-margin-top">
                            <!-- <input type="submit" value="Tambah Invoice" class="uk-button uk-button-primary" disabled> -->
                        ...
                        <table class="uk-table uk-table-divider uk-margin-top">
                            <tbody id="list-item">
                                ...
                                <tr>
                                    ...
                                    <td><input value="{{$item[$i]}}" type="text" name="nama_item[]" id="nama-item" class="uk-input uk-form-width-small" placeholder="Nama Item" readonly></td>
                                    <td><input value="{{$harga[$i]}}" type="number" name="harga[]" id="harga" class="uk-input uk-form-width-small" placeholder="Harga" readonly></td>
                                    <td><input value="{{$diskon[$i]}}" type="number" name="diskon[]" id="diskon" class="uk-input uk-form-width-small" placeholder="Diskon" readonly></td>
                                    <td><input value="{{$subtotal[$i]}}" type="number" name="subtotal[]" id="subtotal" class="uk-input uk-form-width-small" placeholder="Sub Total" readonly></td>
                                    <td><input value="{{$total[$i]}}" type="number" name="total[]" id="total" class="uk-input uk-form-width-small" placeholder="Total" readonly></td>
                                    <td><button class="uk-button uk-button-primary" id="add" disabled>Tambah</button></td>
                                </tr>
                                @endfor
                            </tbody>
                        </table>
